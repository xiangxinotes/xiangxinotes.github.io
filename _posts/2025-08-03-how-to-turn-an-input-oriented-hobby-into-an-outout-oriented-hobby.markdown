...
输入型爱好是指那些你**只**进行**接收**的爱好。比如说：读书。

对于读书来说，你只是买了一本书，读了里面的故事。

你无法和作者对话，你只是全盘接收了作者的观点。

就像现在，你的大脑就在接受内容。

### 输出型爱好

输出型爱好指的是那些你**产出了作品**的爱好。比如说：写书评。

以写书评来说，你读了一本书，然后你把自己的看法和见解写出来，让更多人看见。你的看法和见解就是你的作品。

即使你只是和朋友讨论书本内容，你也产出了作品，只是这个作品的影响力较小。
...
如果你的作品获得了很多人的赞赏，那么通过你的分享实现爱好变现只是时间问题，这也算是意外之喜了，对吧？

比如那些一开始只是分享自己生活的vloger，在获得了足够的关注后，开始慢慢地接广告、接推广、接代言、参加综艺、带货，挣到了更多的钱，也过上了更好的生活。

### 磨练技能

不停的输出会锻炼你的能力，让你不知不觉间得到**能力的提升**。

拿我自己举例，因为工作的原因，我总是经常要用到SQL，但我经常搞混其中的关键字。虽然不是什么大的问题，但是反反复复的去记也很浪费时间。所以去年我建了一个小网站来帮自己记忆这些关键字。

这个网站叫 SQL Wizland: [https://sqlwizland.xiangxi.work](https://sqlwizland.xiangxi.work/){:target="_blank"}，已经在今年5月底上线全部内容了。感兴趣的话可以去看看。 

虽然我创建 [SQL Wizland](https://sqlwizland.xiangxi.work/){:target="_blank"} 的目的只是想让自己复习的时候有个地方可去。但是我发现自己在不知不觉间学到了很多以前不知道的知识。比如说索引、各种主流数据库之间的区别等。
...
其实我在讲输入、输出型爱好的定义时，特地举了读书和写书评这两个例子。因为我想要强调的就是：输入型爱好可以**轻松转化**为输出型爱好。

把输入型爱好变为输出型爱好最简单的方法就是：**分享你遇到的难关，以及你是如何克服的。**

通常情况下，你都不是唯一一个遇到这个问题的人。把你的方法分享出去可以帮助遇到同样问题的人。

就算网上已经有解决方案了，每个人的情况也不一样，你的解决方案依然很有价值。
...
如果你想知道我从书里学到了什么，可以查看<a href="/tag/book">**书单**</a>话题下的文章。
